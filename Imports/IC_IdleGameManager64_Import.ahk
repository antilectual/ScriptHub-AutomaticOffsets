...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.List := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects,"List", [0x58])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.List.effectKeysByKeyName.parentEffectKeyHandler := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.List.effectKeysByKeyName,"Int", [0x10])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.List.effectKeysByKeyName.parentEffectKeyHandler.activeEffectHandlers := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.effects.List.effectKeysByKeyName.parentEffectKeyHandler,"List", [0x128])
...
this.game.gameInstances.Controller.userData.HeroHandler.heroes.List := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes,"List", [0x218])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.List.allUpgradesOrdered.ID := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.List.allUpgradesOrdered,"Int", [0x10])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.List.allUpgradesOrdered.SpecializationName := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.List.allUpgradesOrdered,"UTF-16", [0x40])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.List.allUpgradesOrdered.RequiredLevel := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.List.allUpgradesOrdered,"Int", [0x7c])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.List.allUpgradesOrdered.RequiredUpgradeID := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.List.allUpgradesOrdered,"Int", [0x84])
this.game.gameInstances.Controller.userData.HeroHandler.heroes.List.allUpgradesOrdered.SpecializationGraphic := New GameObjectStructure(this.game.gameInstances.Controller.userData.HeroHandler.heroes.List.allUpgradesOrdered,"Int", [0x88])
...
this.game.gameInstances.Controller.formation.List := New GameObjectStructure(this.game.gameInstances.Controller.formation,"List", [0xa8])
