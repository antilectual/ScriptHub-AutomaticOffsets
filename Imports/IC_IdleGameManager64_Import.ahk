...
this.game.gameInstances.ClickLevel := New GameObjectStructure(this.game.gameInstances,"Int", [0xf8])
this.game.gameStarted := New GameObjectStructure(this.game,"Char", [0xf8])
this.game.gameInstances.ResetsSinceLastManual := New GameObjectStructure(this.game.gameInstances,"Int", [0xe4])
this.game.gameInstances.instanceLoadTimeSinceLastSave := New GameObjectStructure(this.game.gameInstances,"Int", [0xec])
...
this.game.gameInstances.OfflineHandler.OfflineTimeSimulated_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0x8c])
this.game.gameInstances.OfflineHandler.currentModronCore := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0x48])
this.game.gameInstances.OfflineHandler.currentModronCore.ExpTotal := New GameObjectStructure(this.game.gameInstances.OfflineHandler.currentModronCore,"Int", [0x50])
this.game.gameInstances.OfflineHandler.currentModronCore.targetArea := New GameObjectStructure(this.game.gameInstances.OfflineHandler.currentModronCore,"Int", [0x54])
this.game.gameInstances.OfflineHandler.CurrentStopReason_k__BackingField := New GameObjectStructure(this.game.gameInstances.OfflineHandler,"Int", [0x98])
