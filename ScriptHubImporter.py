...
def StartImport(memFileLoc):
    ...
    for effectClassType in effectClassTypeList:
        ...
        Import(effectClassType, True)
    OutputHandlerIncludeFile(effectClassType)

# Reads MemoryLocations file for target variables and builds them into ScriptHub import code (AHK).
def Import(baseClass, isEffectHandler = False):
    global exportedJson
...
def OutputHandlerIncludeFile(effectClassType):
    if effectClassType:
        version = "64"
