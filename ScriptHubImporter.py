...
def Import(baseClass, is64Bit = False, isEffectHandler = False):
    ...
    if not memoryFileLocation.exists():
        ...
        return
    with memoryFileLocation.open('r') as memoryFile:
...
def OutputImportToFile(fileNameBase, version, isEffectHandler):
    ...
    with Path(".", "Imports", extraFolder, "IC_" + fileNameBase + version + "_Import.ahk").open('w') as outputFile:
...
def OutputHandlerIncludeFile(effectClassType, is64Bit ):
    if effectClassType:
        ...
        with Path(".", "Imports", "ActiveEffectHandlers", "IC_HeroHandlerIncludes" + version + "_Import.ahk").open('w') as handlerImportsFile:
...
def CreateVersionFile(architecture):
    ...
    with Path(".", "Imports", "IC_GameVersion" + str(architecture) + "_Import.ahk").open('w') as outputFile:
