...
def CreateVersionFile(architecture):
    ...
    if "value" in exportedJson["CrusadersGame.GameSettings"]["fields"]["VersionPostFix"]:
        versionPostFix = exportedJson["CrusadersGame.GameSettings"]["fields"]["VersionPostFix"]["value"] if exportedJson["CrusadersGame.GameSettings"]["fields"]["VersionPostFix"]["value"] is not "" else "\"\""
