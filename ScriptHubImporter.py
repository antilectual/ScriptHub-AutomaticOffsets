...
def main():
    ...
    if "value" in exportedJson["CrusadersGame.GameSettings"]["fields"]["MobileClientVersion"]:
        CreateVersionFile(32, exportedJson["CrusadersGame.GameSettings"]["fields"]["MobileClientVersion"]["value"])
    memoryStructureLoc = ".\\ScriptHubExport64.json"
    StartImport(memoryStructureLoc, True)
    if "value" in exportedJson["CrusadersGame.GameSettings"]["fields"]["MobileClientVersion"]:
        CreateVersionFile(64, exportedJson["CrusadersGame.GameSettings"]["fields"]["MobileClientVersion"]["value"])
    os.system("pause")
