...
def OutputImportToFile(fileNameBase, version):
    ...
    outputFile = open(".\\IC_" + fileNameBase + version + "_Import.ahk", 'w')
...
def buildMemoryString(classType, variablesStringArray, indexValue):
    ...
    # could not find the variable in the class (Check parents classes?)
    if variablesStringArray[indexValue] not in exportedJson[classType]['fields']:
        ...
        if classType == "UnityGameEngine.Dialogs.Dialog":
            isFound = buildMemoryString( "CrusadersGame.Dialogs.BlessingsStore.BlessingsStoreDialog", variablesStringArray, indexValue) or buildMemoryString(exportedJson[classType]['Parent'], variablesStringArray, indexValue)
        ...
        # found = buildMemoryString(exportedJson[classType]['Parent'], variablesStringArray, indexValue)
